...
class SortedListPQ<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
    ...
    public void insert(K key, V value) {
        ...
        for (int index = 0; index<list.size(); index++){
            if (newEntry.compareTo(list.get(index))< 0){
...
public class ListPQDriver {
    public static void main(String[] args) {
        ...
        System.out.println("Before remove: " + pq1);
        while(!pq1.isEmpty()) {
            System.out.println("Removed: " + pq1.removeMin());
            System.out.println("\tAfter removed: " + pq1);
        }
        ...
        System.out.println("Before remove: " + pq2);
        while(!pq2.isEmpty()){
            System.out.println("Removed: " + pq2.removeMin());
            System.out.println("\tAfter removed: " + pq2);
        }
    }
}